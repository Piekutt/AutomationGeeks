...
Parameters left at "0" disable the associated advanced function. *)
	...
	MpAxisBasicConfigSectionEnum : 
		(
		mcAXIS_BASIC_SEC_ALL, (*Whole configuration structere is used*)
		mcAXIS_BASIC_SEC_DRIVE_CTRL (*Only Drive.Controller section is used*)
		);
	MpAxisBasicConfigCmdEnum : 
		...
		mcAXIS_BASIC_CFG_LOAD_FROM_CFG, (*Loads the currently stored configuration on the target system to the parameterization of the axis*)
		...
		mcAXIS_BASIC_CFG_WRITE_AND_SAVE, (*Writes the settings specified in the process variable to the parameterization of the axis and saves it into axis configuration*)
	...
	MpAXBHWModuleChannelEnum : 
		(
		mcAXIS_BASIC_CFG_HW_CHANNEL1, (*Channel 1 of hw module*)
		mcAXIS_BASIC_CFG_HW_CHANNEL2, (*Channel 2 of hw module*)
		mcAXIS_BASIC_CFG_HW_CHANNEL3 (*Channel 3 of hw module*)
		);
	MpAXBHWModuleAxTypeEnum : 
		(
		mcAXIS_BASIC_CFG_HW_AXIS_REAL, (*Real axis configuration section*)
		mcAXIS_BASIC_CFG_HW_AXIS_VIRT, (*Virtual axis configuration section*)
		mcAXIS_BASIC_CFG_HW_AXIS_EXT_ENC (*External encoder configuration section*)
		);
	MpAXBHWModuleType : 	STRUCT 
		OrderNumber : STRING[250];
		Address : STRING[250];
		Channel : MpAXBHWModuleChannelEnum;
		AxisType : MpAXBHWModuleAxTypeEnum;
	END_STRUCT;
	MpAxisBasicConfigParType : 	STRUCT 
		Data : REFERENCE TO MpAxisBasicConfigType;
		Section : MpAxisBasicConfigSectionEnum;
		AxisName : STRING[250];
		HWModule : MpAXBHWModuleType;
	END_STRUCT;
END_TYPE
